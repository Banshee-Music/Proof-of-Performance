...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface IIdentityVerifierInterface extends Interface {
  ...
  export interface IIdentityVerifier extends BaseContract {
    ...
    connect(runner?: ContractRunner | null): IIdentityVerifier;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    verify: TypedContractMethod<
      [proof: BytesLike, identityHash: BytesLike, ],
      [boolean],
      'view'
    >
